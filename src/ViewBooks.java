...
public class ViewBooks extends javax.swing.JFrame {
       ...
       private void initComponents() {
              ...
              if (ResultTable.getColumnModel().getColumnCount() > 0) {
                     ...
                     ResultTable.getColumnModel().getColumn(1).setMinWidth(180);
                     ResultTable.getColumnModel().getColumn(1).setPreferredWidth(180);
                     ResultTable.getColumnModel().getColumn(2).setMinWidth(130);
                     ResultTable.getColumnModel().getColumn(2).setPreferredWidth(130);
                     ResultTable.getColumnModel().getColumn(3).setMinWidth(110);
              ...
              SortByComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Default (Book Number)", "Book Name", "Author", "Publisher", "Pages", "Stock", "Balance" }));
       ...
       private void EditButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditButtonActionPerformed
              this.setVisible(false);
              new EditBook(Integer.parseInt(ResultTable.getValueAt(ResultTable.getSelectedRow(), 0).toString())).setVisible(true);
       }//GEN-LAST:event_EditButtonActionPerformed

       private void DeleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteButtonActionPerformed
              this.setVisible(false);
              new DeleteBook(Integer.parseInt(ResultTable.getValueAt(ResultTable.getSelectedRow(), 0).toString())).setVisible(true);
              ...
              if (cb.getSelectedIndex() != -1){
                     ...
                     try{
                            ...
                            switch (index) {
                                   ...
                                   case 4:
                                          query = "select * from books order by pages;";
                                          break;
                                          
                                   case 5:
                                          query = "select * from books order by stock;";
                                          break;
                                          
                                   case 6:
                                          query = "select * from books order by balance;";
                                          break;
                                          
                                   default:
                                          query = "select * from books order by bookNo;";
                                          break;
                            }
